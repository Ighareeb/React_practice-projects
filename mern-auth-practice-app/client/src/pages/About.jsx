	...
	return (
		<div className="px-4 py-12 max-w-2xl mx-auto">
			...
			<p className="mb-4 text-slate-700">
				...
				labore ex qui ipsum maxime blanditiis aliquid! Reiciendis tempore
				exercitationem eligendi iusto sunt labore? Recusandae accusamus aliquam
				voluptas? Sapiente, ea.
			</p>
		</div>
	);
}
