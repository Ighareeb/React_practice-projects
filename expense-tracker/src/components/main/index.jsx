...
export default function Main() {
	const { isOpen, onOpen, onClose } = useDisclosure(); //custom chakra hook to handle open/close/toggle behaviours
	const {
		totalExpense,
		setTotalExpense,
		totalIncome,
	...
	return (
		<Flex textAlign={'center'} flexDirection={'column'} pr={'5'} pl={'5'}>
			<Flex alignItems={'center'} justifyContent={'space-between'} mt={'12'}>
				<Heading
					color={'blue.400'}
					display={['none', 'block', 'block', 'block', 'block']} //[base, sm, md, lg, xl] for responsive styles
				>
					Expense Tracker
				</Heading>
